...
public class DbDemo {
    private final PortalService portalService = new PortalService(RepositoryFactory.portalRepository());
    private final JoblistingService jobService = new JoblistingService(RepositoryFactory.joblistingRepository());
